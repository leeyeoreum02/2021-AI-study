...
def read_langs(lang1, lang2, reverse=False):
    ...
    lines = open(f'../pytorch-tutorial/text-4/{lang1}-{lang2}.txt', encoding='utf-8').\
        read().strip().split('\n')
...
def show_plot(points):
    ...
    plt.plot(points)
    plt.savefig('pytorch_tutorial_text_4_1.png')
...
def show_attention(input_sentence, output_words, attentions):
    ...
    plt.show()
    plt.savefig('pytorch_tutorial_text_4_3.png')
...
if __name__ == '__main__':
    ...
    plt.savefig('pytorch_tutorial_text_4_2.png')
